...
vector<double> LinearEquation::solveLinearEquation(vector<vector<double>> matrix, vector<double> vector)
{
...
double LinearEquation::determinant(vector<vector<double>> matrix)
{
    // One of the things to check.
	if (matrix.size() == 0)
	{
